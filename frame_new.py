...
class Backend:
    ...
    def __init__(self):
        ...
        self.left = self.left + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz!#$%&()*,/1234567890:;<.>?@\^№|-+=_~`{} []\"\'"
        self.up = "АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдеёжзийклмнопрстуфхцчшщъыьэюя"
        self.up = self.up + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz!#$%&()*,/1234567890:;<.>?@\^№|-+=_~`{} []\"\'"
        ...
        # todo: добавить это в иконку
        # image = PhotoImage(file="image/file.png")

    def write_key_word(self):
